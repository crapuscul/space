...
// Correct import paths for the images
...
export default function TechnologyPage() {
  ...
  const [selectedTechnology, setSelectedTechnology] = useState("technology1");
    ...
    return (
      <div>
        <img
          ...
          alt={`${technology.techName} Landscape`}
        />
        <img
          className="image-portrait"
          src={technology.imagePortrait}
          alt={`${technology.techName} Portrait`}
        />
      </div>
    );
  };
            ...
            <nav className="tech-nav">
              <ul>
                <li
                  ...
                  onClick={() => setSelectedTechnology("technology1")}
                >
                  1
                </li>
                <li
                  ...
                  onClick={() => setSelectedTechnology("technology2")}
                >
                  2
                </li>
                <li
                  ...
                  onClick={() => setSelectedTechnology("technology3")}
                >
                  3
                </li>
              </ul>
