...
export default function DestinationPage() {
  ...
  const sections = {
    section1: {
      picture: require("./assets/images/destination/image-moon.png"),
      heading: "MOON",
    ...
    section3: {
      picture: "./src/assets/images/destination/image-europa.png",
    ...
    section4: {
      picture: "./src/assets/images/destination/image-titan.png",
