...
export default function CrewPage() {
  ...
  const crewMembers = {
    ...
    crew2: {
     picture:"./src/assets/images/crew/image-mark-shuttleworth.png",
      title: "MISSION SPECIALIST",
      name: "MARK SHUTTLEWORTH",
      description: "Mark Richard Shuttleworth is the founder and CEO of Canonical, the company behind the Linux-based Ubuntu operating system. Shuttleworth became the first South African to travel to space as a space tourist."
    },
    crew3: {
     picture:"./src/assets/images/crew/image-victor-glover.png",
      title: "PILOT",
      name: "VICTOR GLOVER",
      description: "Pilot on the first operational flight of the SpaceX Crew Dragon to the International Space Station. Glover is a commander in the U.S. Navy where he pilots an F/A-18. He was a crew member of Expedition 64, and served as a station systems flight engineer."
    },
    crew4: {
      picture:"./src/assets/images/crew/image-anousheh-ansari.png",
  ...
  const renderCrewPicture =()=> {
    const crewMember = crewMembers[selectedCrew];
    return(
      <div><img src={crewMember.picture}/></div>
    )
  }
    return (
          ...
          <div className="box-left">
           ...
           {renderCrewContent()}
            ...
            <div className="crew-members-pagination">
                  <div className={`dot ${selectedCrew === "crew1" ? "selected" : ""}`}
                  onClick={()=> setSelectedCrew("crew1")}></div>
                  <div className={`dot ${selectedCrew === "crew2" ? "selected" :""}`}
                  onClick={()=> setSelectedCrew("crew2")}></div>
                  <div className={`dot ${selectedCrew === "crew3" ? "selected" :""}`}
                  onClick={()=> setSelectedCrew("crew3")}></div>
                  <div className={`dot ${selectedCrew === "crew4" ? "selected" :""}`}
                  onClick={()=> setSelectedCrew("crew4")}></div>
              </div>
